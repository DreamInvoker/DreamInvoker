...
My research interests now include Large Vision-Language Model (LVLM), Retrieval-augmented Generation (RAG), Text2SQL, Information Retrieval (IR) and Question Answering (QA). My previous research interests include Graph Neural Networks (GNNs), Information Extraction (IE), and knowledge graphs (KGs).
